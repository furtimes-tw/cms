...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_posts_category" AS ENUM('Newsflash', 'Report', 'Sponsor', 'Column', 'Interview');
  CREATE TYPE "public"."enum_sponsors_sponsor_type" AS ENUM('company', 'individual');
  CREATE TYPE "public"."enum_sponsors_tier" AS ENUM('primary', 'secondary', 'standard', 'supporter', 'special');
  ...
  CREATE TABLE "posts" (
  	...
  	"featured_order" numeric DEFAULT 100,
  ...
  CREATE TABLE "sponsors" (
  	...
  	"sponsor_type" "enum_sponsors_sponsor_type" DEFAULT 'company' NOT NULL,
